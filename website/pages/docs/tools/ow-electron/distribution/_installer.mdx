Your app's user experience starts as soon as the user runs it for the first time. To help you make it a success from the very start, we have created a customizable, generic installer that you can use.

This installer will (optionally) handle any of the following:
...
Apart from that, most of the installer's text/graphics can be changed/configured to fit your specific app.
