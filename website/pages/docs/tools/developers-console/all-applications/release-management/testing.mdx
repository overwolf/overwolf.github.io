...
Under this tab, you can set up custom [**App Channels**](/tools/all-applications/release-management#what-are-release-channels). These allow you to deploy different versions of your app to specific, hand-picked users.
For example:
...
The rest of the window allows us to [manage the channel](/tools/all-applications/release-management#manage-an-app-channel) like any other channel.
