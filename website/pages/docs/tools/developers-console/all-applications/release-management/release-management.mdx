...
```js
`https://console-api.overwolf.c/tools/developers-consoleapps/${app-id}/versions/${version}/release-notes/${page}`
```
...
```js
`https://console-api.overwolf.c/tools/developers-consoleapps/npijmgiaiiemcnijaljcfddgeihcbifdbhpffihe/versions/6.0.71/release-notes/${page}`
```
