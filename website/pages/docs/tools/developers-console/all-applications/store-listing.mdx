...
- Full description - A full description for your app, displayed on your app's store page. Uses [CommonMark](https://commonmark.org/).
  - Similarly to [Release Notes](release-management#release-notes), there is a `Preview` button to see how the final description looks.
...
[visibility](/assets/tools/developers-console/all-applications/update-store/hidden.png)
