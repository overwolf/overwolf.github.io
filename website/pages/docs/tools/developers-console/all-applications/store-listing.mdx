...
Before your app can be listed in the store, it has to have all of [its assets prepared](/start/submit-your-app#prepare-your-store-assets).
However, your app can exist on the console even before that, in a `hidden` state.

When an app is in `hidden` mode, only users with a direct download link will be able to find your app's store page and download it.
You can use this for pre-launch testing.

When your app is ready to launch, it will be changed to be `visible`, and your app will become listed on the store.

:::note Unlisting Your App
If at any point, you wish to unlist your app, either temporarily, or permanently, contact your DevRel manager, and they will help you with it.
:::
