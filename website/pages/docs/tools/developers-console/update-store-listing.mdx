...
![login](/assets/tools/developers-console/update-store/login.png)
...
![name-author](/assets/tools/developers-console/update-store/name-author.png)
...
![visibility](/assets/tools/developers-console/update-store/hidden.png)
...
![app_url](/assets/tools/developers-console/update-store/app_url.png)
...
![monetization](/assets/tools/developers-console/update-store/monetization.png)
...
![short-desc](/assets/tools/developers-console/update-store/short-desc.png)
...
![full-desc](/assets/tools/developers-console/update-store/full-desc.png)
...
![tags](/assets/tools/developers-console/update-store/tags.png)
...
![tile](/assets/tools/developers-console/update-store/tile.png)
...
![icon](/assets/tools/developers-console/update-store/icon.png)
...
![screenshots](/assets/tools/developers-console/update-store/screenshots.png)
