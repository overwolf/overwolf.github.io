...
The **Developer's Console** (also sometimes known as the **Dev Console**), serves as the go to place for managing your applications.

:::note
An application does not have to be "public" in order to be accessible on the console. It can exist in "hidden" mode, where it can only be
downloaded by users with a direct download link to the app. For more details, feel free to contact your dev-rel manager
(or just [contact us](/support/contact-us) if you do not yet have a dev-rel manager)
:::
