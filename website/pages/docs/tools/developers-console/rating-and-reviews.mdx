...
![welcome-screen](/assets/tools/developers-console/rating-and-reviews/main-screen.png)
...
![feedback-appstore](/assets/tools/developers-console/rating-and-reviews/feedback-appstore.png)

And on the "Rating and Reviews" page in the dev console, where you can reply to each review:

![feedback](/assets/tools/developers-console/rating-and-reviews/feedback.png)
...
![feedback-info](/assets/tools/developers-console/rating-and-reviews/feedback-info.png)
