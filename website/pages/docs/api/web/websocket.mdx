...
:::note
`web.websocket` is an instance an overwolf websocket. These can be created using the [`overwolf.web.createWebSocket()`](.#createwebsocketconnectionparams-callback) method.
:::
