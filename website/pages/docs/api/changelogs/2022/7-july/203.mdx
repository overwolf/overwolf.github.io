...
* [Valorant](/api/games/events/valorant)
  * New event - scoreboard. More info [here](/api/games/events/valorant#scoreboard-note)
* [Axie Infinity Origin](/api/games/events/axie-infinity-origin)
...
- Fixed a bug involving issues with dragging native overwolf windows.
