...
- New API
    - [`overwolf.social.uploadVideo`](/api/social#uploadvideouploadvideo-callback-callback) - Upload a video to the buffer server, getting a link to the raw file.
...
#### Bug Fixes
- [`overwolf.media.replays.ReplayVideoOptions`](/api/media/replays#replayvideooptions-object) is no longer required inside of [`/api/media/replays#replaystreamparams-object`] when empty.
