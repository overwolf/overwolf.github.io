...
* Valorant.
  * Added new update: **pseudo_match_id**  under [match_info](/api/game-data/supported-games/valorant#match_info).
* COD: Warzone.
  * Added new update: **pseudo_match_id**  under [match_info](/api/game-data/supported-games/call-of-duty-warzone-caldera#match_info).
* Overwatch.
  * Added new update: **pseudo_match_id**  under [match_info](/api/game-data/supported-games/overwatch-2#match_info).
