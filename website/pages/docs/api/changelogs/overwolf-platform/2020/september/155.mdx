...
* [Hearthstone](/api/game-data/supported-games/hearthstone) - "match_end" now includes a match outcome value.d
* [League of Legends](/api/game-data/supported-games/league-of-legends#live_client_data) - new event - "port". Random port that comes from Riot
