...
* [WARFRAME](/api/game-data/supported-games/warframe)
  * New updates and events under:
    * inventory
    * username
* [Call of Duty - Warzone](/api/game-data/supported-games/call-of-duty-warzone-caldera)
  * New updates and events under:
    * match_info
    * game_info
* [Fortnite](/api/game-data/supported-games/fortnite)
  * New update under:
    * me
    * match_info
* [World of Warcraft](/api/game-data/supported-games/world-of-warcraft)
  * New update under:
    * group_applicants
...
* [Warframe](/api/game-data/supported-games/warframe)
  * New updates under:
    * match_info
* [APEX LEGENDS](/api/game-data/supported-games/apex-legends)
  * New updates under:
    * match_info
