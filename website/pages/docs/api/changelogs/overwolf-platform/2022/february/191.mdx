 ...
 * [Rainbow Six Siege](/api/game-data/supported-games/rainbow-six-siege)
   * Add player_id in roster - [here](/api/game-data/supported-games/rainbow-six-siege#roster)

<div>{/* * [World of Warcraft](/api/game-data/supported-games/world-of-warcraft)
  * Add new event for Addons varaibles var_addon_xx */} </div>

 * [Halo Infinite](/api/game-data/supported-games/halo-infinite)
