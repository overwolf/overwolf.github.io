...
* [CS:GO](/api/live-game-data/supported-games/counter-strike-global-offensive)
  * Add ping event
  * Add nickname, ping and local_player parameters to the scoreboard - see notes [here](/api/live-game-data/supported-games/counter-strike-global-offensive#scoreboard)
