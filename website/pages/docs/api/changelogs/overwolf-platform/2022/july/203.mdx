...
### Game events
* [TFT](/api/game-data/supported-games/teamfight-tactics)
  * Support for all the events in TFT PBE
* [Valorant](/api/game-data/supported-games/valorant)
  * New event - scoreboard. More info [here](/api/game-data/supported-games/valorant#scoreboard-note)
* [Axie Infinity Origin](/api/game-data/supported-games/axie-infinity-origin)
