...
* Rainbow Six Siege
	* New "suffix" field was added in roster event. According to Ubisoft privacy rules, in case there is a value in this field it must be linked to the player's name field wherever it appears during the match - More details [here](/api/game-data/supported-games/rainbow-six-siege#roster_xx-notes)

* Axie Infinity origin
	* New game support - More details [here](/api/game-data/supported-games/axie-infinity-origin)

* Valorant
	* New map support for Pitt - Pearl. More details [here](/api/game-data/supported-games/valorant)

* Dota 2
	* New support for Hero Pool detection for Captain’s Draft [here](/api/game-data/supported-games/dota-2)

* Diablo 2
	* New game events. More details [here](/api/game-data/supported-games/diablo-2-resurrected)
