...
* [Warzone](/api/game-data/supported-games/call-of-duty-warzone-caldera)
  * New update & note for:
    * roster
* [New World](/api/game-data/supported-games/new-world)
  * New supported game.
* [Eternal Return](/api/game-data/supported-games/eternal-return)
  * New supported game.
* [Hearthstone](/api/game-data/supported-games/hearthstone)
  * New info update:
    * arena
