...
### API
- New API - [`overwolf.profile.performOverwolfSessionLogin()`](/api/profile#performoverwolfsessionlogintoken-callback):
  - Uses a temporary session token to connect the users' client to an Overwolf Account.
