...
Please read the [overwolf.games.launchers.events](/api/game-data#how-to-register-for-features) documentation page to learn how to use Overwolf game launchers events.
