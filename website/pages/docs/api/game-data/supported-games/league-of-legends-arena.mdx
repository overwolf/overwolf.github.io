...
Please read the [overwolf.games.events](/api/game-data) documentation page to learn how to use Overwolf game events.

**Note** that LOL Arena, LOL Arena PBE and LOL share the same Game ID.

:::tip
Note that you can also use the LOL game launcher events. Read more [here](/api/game-data/supported-launchers/league-of-legends).
:::
...
Note that you can also get this info earlier by using the [LEP region info-update](/api/game-data/supported-launchers/league-of-legends#summoner_info).
