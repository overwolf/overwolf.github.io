...
:::tip
If you would like to know when the user is going to play TFT (hit the "Play" button), you can listen to the LoL Launcher [lobby_info](/api/game-data/supported-launchers/league-of-legends#info-updates-3) info-update, and check the `queueID`. If it's 1090 or 1100 - it's TFT, or 1130, for "Hyperoll".
:::
...
```json
{"info":{"match_info":{"round_type":"{\"stage\":\"1-1\",\"name\":\"Portal\",\"type\":\"Portal\"}"}},"feature":"match_info"}
...
{"info":{"match_info":{"round_type":"{\"stage\":\"2-4\",\"name\":\"Carousel\",\"type\":\"Carousel\"}"}},"feature":"match_info"}
```
