...
In order to know which user is already using this command line parameter, you should use the [`overwolf.games.getGameInfo()`](/api/games#getgameinfogameclassid-callback) API, where you will get this parameter in the response under gameInfo --> GameInfo --> ProcessCommandLine.
:::
