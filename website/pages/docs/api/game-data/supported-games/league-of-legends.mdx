...
:::tip
matchEnd is deprecated, you can use the [announcer](#announcer) DEFEAT/VICTORY instead or the launcher game flow [here](/api/game-data/supported-launchers/league-of-legends#game_flow)
:::
