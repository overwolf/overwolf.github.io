...
* [overwolf.social.uploadVideo()](#uploadvideouploadparams-callback-callback)
...
## uploadVideo(uploadParams, resultCallback, progressCallback)
#### Version added: 0.203
...
Parameter | Type                       | Description                                                             |
--------- | ---------------------------| ----------------------------------------------------------------------- |
uploadParams  | [UploadVideoParameters](#uploadvideoparams-object) => void  | returns a list of disabled services     |
resultCallback  | [(Result: GetDisabledServicesResult)](#getdisabledservicesresult-object) => void  | returns a list of disabled services     |
progressCallback  | [(Result: GetDisabledServicesResult)](#getdisabledservicesresult-object) => void  | returns a list of disabled services     |
...
When calling [`overwolf.social.uploadVideo()`](#uploadvideouploadparams-callback-callback), it is required to supply it with a request ID. This ID will also be used in case you wish to cancel this share using [`overwolf.social.cancelUpload()`](#canceluploadstring-callback).


## UploadVideoResult Object
#### Version added: 0.203
...
> The current state of the [`overwolf.social.uploadVideo()`](#uploadvideouploadparams-callback-callback) operation.
