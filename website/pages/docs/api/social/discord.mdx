...
Since version 0.153, the "file" param is optional when calling [`overwolf.social.discord.share()`](#sharediscordshareparameters-callback) or [`overwolf.social.discord.shareEx()`](#shareexdiscordshareparameters-callback-callback).
Instead, you can use the "message" param to include a URL of a file that you want to share.
