...
* Triggered only for the current extension hotkeys.
* This event will replace the deprecated [overwolf.settings.registerHotKey()](.#registerhotkeyactionid-callback) function, as a way to register for hotkey events.
