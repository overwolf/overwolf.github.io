...
> Generates and configures a user's [email hashes][liveramp-hash-identifier] persistently directly from the raw email.
...
> Configures a user's [email hashes][liveramp-hash-identifier] persistently from pre-configured email hashes.
...
> An object containing different hash patterns of a relevant user's [email address][liveramp-hash-identifier].
...
[liveramp-hash-identifier]: https://docs.liveramp.com/connect/en/hashing-identifiers.html