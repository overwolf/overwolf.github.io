...
| sources | [overwolf.media.replaysVideoSource](media/replays#videosource-object)[] | Add sources to video. See [note](#sources-notes)   | 0.159  |
...
Read about [overwolf.media.replaysVideoSource](media/replays#videosource-object) for more info.  
