...
* Desired [deeplink scheme](/api/manifest#url_protocol-object) - The custom scheme to be used when redirecting back into your App from the subscription checkout flow.
