...
For specific use cases, please refer to [Guidelines for ad integration](/start/monetize-your-app/ads-sdk#guidelines-for-ad-integration).
...
-------------------| --------------------------------| ------------------------------------------------- |
size               | [ContainerSize](#containersize-object) \| [ContainerSize](#containersize-object)[] | The size(s) of Ad containers that this Ad container can become. See [Available Ad Sizes](#available-ad-sizes) |
