...
Note that some of the games (e.g [CS:GO](games/events/csgo)) can run in "trusted mode," which disable the "exclusive mode" in the game and makes it impossible to  interact with your OW app window.
