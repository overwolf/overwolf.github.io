...
Note that some of the games (e.g [CS:GO](/api/game-data/supported-games/counter-strike-global-offensive)) can run in "trusted mode," which disable the "exclusive mode" in the game and makes it impossible to  interact with your OW app window.
