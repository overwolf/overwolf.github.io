...
```json
{
    ...
    "data": {
        ...
        "<a id="developer-manifest" href="#developer-game-settings">developer": {
...
| <a className="anchor" aria-hidden="true" id="meta-description"></a>description    | string   |  Mandatory. Your app's description in the Appstore tile. Limited to 180 characters.                   | 0.78  |
...
| <a className="anchor" aria-hidden="true" id="meta-launcher_icon"></a>launcher_icon | string   |  A relative path from the app folder to the desktop shortcut icon’s ico file. This is a colored icon for the app’s desktop shortcut. More info [here](/start/submit-your-app/submit-your-app-to-the-store#opk-structure).                             | 0.78  |
...
:::important
<a className="anchor" aria-hidden="true" id="meta-note"></a>Each app has a unique id (UID) that is generated out of the “name” and “author” strings. Once an app is published on the Appstore, its UID can’t be changed, so please choose your app and author names wisely before [submitting](/start/submit-app-proposal) your app.
...
| <a className="anchor" aria-hidden="true" id="user_agent"></a>user_agent | string |  A custom user agent for the app to use when creating http requests. <br/> **Please read our [notes](#user_agent-notes)** |0.86  |
...
| <a className="anchor" aria-hidden="true" id="process_name"></a>process_name | string |  Overrides the default (OverwolfBrowser.exe) process name in task manager. <br/> **Please read our [notes](#process_name-notes)** | 0.153  |
...
| <a className="anchor" aria-hidden="true" id="windows-block_top_window_navigation"></a>block_top_window_navigation | bool |  Refrain from non "target=_blank" html elements from “taking-over” the entire app’s window                         | 0.100  |
...
| <a className="anchor" aria-hidden="true" id="restrict_to_game_bounds"></a>restrict_to_game_bounds | bool |  A window will always stay inside the game window while dragging.| 0.158  |
