...
:::tip
To delete old videos you can use [overwolf.media.videos.deleteOldVideos()](media/videos#deleteoldvideoskeepnewestxgbs-callback), and to delete old screenshots you can use [overwolf.extensions.io.delete()](extensions/io#deletespace-path-callback).
:::
