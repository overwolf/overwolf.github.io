...
The `match_id` field from this event is equal to the `pseudo_match_id` from [match_info](/api/game-data/supported-games/league-of-legends#match_info).
