...
Parameter         | Type                                        | Description             |
------------------| --------------------------------------------| ----------------------- |
source_type       | [overwolf.media.enums.eSourceType](../media#esourcetype-enum)            |                         | 
name              | string                                      |                         | 
...
transform         | [overwolf.media.enums.eVideoSourceTransform](../media#evideosourcetransform-enum)  |                         | 
