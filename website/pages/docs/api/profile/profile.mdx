...
* [overwolf.profile.performOverwolfSessionLogin()](#performoverwolfsessionlogintoken-callback)
...
## performOverwolfSessionLogin(token, callback)
#### Version added: 0.236

> Uses a temporary token to log-in the Overwolf Client to the relevant user.

Parameter | Type     | Description                                                                                        |
----------| ---------| -------------------------------------------------------------------------------------------------- |
token     | string | The temporary token to be used for logging in |
callback  | (Result: Result) => void | A function called with the result of the operation |
