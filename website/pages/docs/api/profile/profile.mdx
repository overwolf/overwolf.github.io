...
This token can then be tested against the [relevant endpoint](#token-authentication), to confirm the authenticity of this session, for use in external applications.

Parameter   | Description                                              |
----------- | -------------------------------------------------------- |
duration    | 15 minutes from the moment of creation. See [note](#token-expiry-note) |
payload.sub | Username for the account                                 |
...
The following status codes may then be returned:
- `200` - Token is valid
