...
:::warning
* Support for these events is for English only and for 16:9 (1920*1080) and 16:10 (1980*1200) screen resolutions on , the game window must be visible and should run with native screen resolution.
