...
shop    | open/close  | When the shop window is open or close |See [notes](#shop-note)|   240       |
...
key          | Category    | Values                    | Notes                 | Since GEP Ver. |
------------ | ------------| ------------------------- | --------------------- | ------------- | 
players_location    | location   | The player's current position (x,y,z).   |  See [notes](#location-note) |   240    |
...
```json
{"feature": "location", "category": "location", "key": "players_location", "data": "{\"x\":-1626.63,\"y\":-7291.47,\"z\":200.299}"}
```
