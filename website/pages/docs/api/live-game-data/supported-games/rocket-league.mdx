...
* Encoded stringified JSON containing the properties:
  ...
  * name –  Name of the player that died
  * team – Team number of the player (1 or 2)
  * platform - The platform current platform name 
...
Event       | Event Data   | Fired When    | Notes              | Since GEP Ver. |
------------| -------------| --------------| ------------------ | --------------|
training_round| The current round number in the training pack |New round starts|See [notes](#training_round-note)|      236.0     |
