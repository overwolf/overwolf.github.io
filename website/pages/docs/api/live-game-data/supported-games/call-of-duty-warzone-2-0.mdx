---
id: call-of-duty-warzone-2-0
image: "/img/embed/games/call-of-duty-warzone-2-0.jpg"
title: "Call of Duty: Warzone 2.0 Game events"
hide_title: true
sidebar_label: "Call of Duty: Warzone 2.0"
sidebar_position: 0
...
<head>
  <meta name="keywords" content="API for Call of Duty: Warzone 2.0, Call of Duty: Warzone 2.0 API, SDK for Call of Duty: Warzone 2.0, Call of Duty: Warzone 2.0 SDK"/>
</head>

<GameInfo gameId={223281} page="docs" />

Please read the [overwolf.games.events](/api/live-game-data) documentation page to learn how to use Overwolf game events.

:::warning

* Support for these events is for 16:9 and 16:10 screen resolutions, the game window must be visible and should run with native screen resolution. 
...
* In addition, when developing your app, you must comply with Activision’s Call of Duty:Warzone 2.0 terms and conditions. Supporting que dodging, interfering with matchmaking or any such behavior is strictly prohibited, and will not be approved. If you have any doubt, please contact us directly before starting development.
...
## Sample Apps
* [Warzone 2.0 game events sample app](https://github.com/overwolf/events-sample-app)
...
Match end event include the match outcome
...
key          | Category    | Values                    | Notes                 | Since GEP Ver. |
------------ | ------------| ------------------------- | --------------------- | ------------- | 
scene| game_info   | current player's scene. |See [notes](#scene-note)|   239.0       |
game_mode| game_info   | current game mode selected by the player. |See [notes](#game_mode-note)|   239.0       |
...
```json
{"feature":"game_info","category":"game_info","key":"scene","value":"airplane"}
```
...
```json
{"feature":"game_info","category":"game_info","key":"mode","value":"wz2"}
```
