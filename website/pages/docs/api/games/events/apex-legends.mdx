...
legendSelect_X| match_info | The name of the legend & order of selection for every member in the team, including noting who the jump-master is. | See [notes](#legendSelect_X-note)|  128.0 |
...
```json
 {"info":{"match_info":{"legendSelect_1":"{\"playerName\":\"□JacksAtWork□\",\"legendName\":\"#character_wraith_NAME\",\"selectionOrder\":\"1\",\"lead\":true,\"is_local\":true}"}},"feature":"team"}
```
