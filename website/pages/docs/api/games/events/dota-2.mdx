...
In Immortal Draft use "team_slot" instead of "index" to detected the accurate slot of all players 
...
mmr              | me          | MMR and confidence value of the player | See [notes](#mmr-note) |  139.0         |
...
{"feature":"me","category":"me","key":"mmr","value":"{\"mmr\": 2180,\"confidence\" : 35}"}
```
