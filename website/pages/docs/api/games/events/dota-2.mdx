...
In order to know which user is already using this command line parameter, you should use getGameInfo API, there you will get this parameter in the response under gameInfo --> GameInfo --> ProcessCommandLine - [More details here](../)
:::
