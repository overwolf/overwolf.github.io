...
key          | Category    | Values                    | Notes                 | Since GEP Ver. |
------------ | ------------| ------------------------- | --------------------- | ------------- |
training_pack| game_info   | On selecting a training pack     |  See [notes](#training_pack-note)                     |    235.0       |
...
Event       | Event Data   | Fired When    | Notes              | Since GEP Ver. |
------------| -------------| --------------| ------------------ | --------------|
training_round| null |New round starts|See [notes](#training_round-note)|      235.0     |
