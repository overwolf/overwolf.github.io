...
It's recommended to communicate errors and warnings to your users. You can check game event status [here](/status/all) or easily verify event status directly from your app [using our API](/topics/using-events/how-to-check-events-status-from-app).
