...
<GameInfo gameID={9898} showCompliance={true} showDocs={false}/>
...
It is highly recommended to communicate errors and warnings to your app users. Check game event status [here](/status/all), or easily check game events status from your app [using our API](/topics/using-events/how-to-check-events-status-from-app).
