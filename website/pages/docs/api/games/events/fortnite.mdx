...
```json
{"feature":"map","category":"match_info","key":"creative_map","value":"{\"map_id\":\"0353-9713-7218\",\"title\":\"Cyber_Dragon_Hub\",\"account_id\":\"7f1f209123164b1bbf905ad1ef9990de\",\"version\":\"2\"}"}
```
