...
:::tip
Note that you can also use the LOL game launcher events. Read more [here](../launchers/events/league-of-legends).
:::

## Sample Apps

* [LOL ARENA game events sample app](https://github.com/overwolf/events-sample-apps)

<SkipMe>
* [Summoner and team info sample app](https://github.com/overwolf/lol-summoner-team-info-sample-app) – this sample app gets “summoner region” and “my team” info during the champion selection phase, before the game begins. More information about getting data from LoL launcher/client can be found [here](../launchers).
</SkipMe>
...
match_outcome | game_info  | The final march outcome  |See [notes](#match_outcome-note)|   230.0       |
...
Data Example:
```
{"feature":"match","category":"game_info","key":"match_outcome","value":"victory"}
```
...
Note that you can also get this info earlier by using the [LEP region info-update](../launchers/events/league-of-legends#summoner_info).
...
key         | Category    | Values                                                                                | Notes                 | Since GEP Ver. |
----------- | ------------| --------------------------------------------------------------------------------------| --------------------- | ------------- |
teams       | game_info   |  A JSON object with the teams formation        |   See [notes](#teams-note)                  |   70.0        |


#### *teams* note

Arena is a 2 Vs 2 VS 2 Vs 2 game mode, the JSON response is ordered in the same way. 
The first 2 players are on the same team, the next 2 players are on another team, and so on. 

```json
"[{"team":"Order","champion":"Azir","skinId":"0","summoner":"'Nano888' **local**"},
{"team":"Order","champion":"Brand","skinId":"0","summoner":"'assemblyus'"},
{"team":"Order","champion":"MissFortune","skinId":"40","summoner":"'omobogoshipoop'"},
{"team":"Order","champion":"Yone","skinId":"0","summoner":"'goingb'"},
{"team":"Order","champion":"Naafiri","skinId":"0","summoner":"'zé fodinha'"},
{"team":"Order","champion":"Taric","skinId":"4","summoner":"'ikunheihei'"},
{"team":"Order","champion":"Teemo","skinId":"4","summoner":"'we all smell'"},
{"team":"Order","champion":"Samira","skinId":"30","summoner":"'dirkbeefhammer'"}]"
```
