...
```json
{"info":{"match_info":{"scoreboard_1":"{\"name\":\"PlayerName #7777\",\"teammate\":false,\"character\":\"Wushu\",\"kills\":15,\"deaths\":13,\"assists\":1,\"money\":4850,\"is_local\":true}"}},"feature":"match_info"}
```
