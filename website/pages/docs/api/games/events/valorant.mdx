...
```json
{"info":{"match_info":{"kill_feed":"{\"attacker\":\"shyni\",\"victim\":\"VINn\",\"weapon\":\"TX_Hud_Operator\",\"ult\":0,\"assist1\":\"TX_Killfeed_Brimstone\",\"assist2\":\"\",\"assist3\":\"\",\"assist4\":\"\",\"headshot\":false,\"assist\":null}"}},"feature":"match_info"}
```
