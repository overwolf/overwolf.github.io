...
<GameInfo gameID={10906} showCompliance={true} showDocs={false}/>
...
inVehicle       | me   | Whether local player is inside a vehicle or not.<ul><li>‘null’Bool - ‘True‘/‘False‘ </li></ul>| Valid for the airplane as well. |  128.0        |
...
freeView       | me   | When the local player uses ‘ALT’ feature to look around.<ul><li>Bool - ‘True‘/‘False‘</li> </ul>|                       |  128.0        |
