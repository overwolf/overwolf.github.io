...
Custom matches are not supported in game_mode_log. To detect a custom match use "contextName":"CUSTOMGAME_PVP_DEDICATED" for online or "contextName":"CUSTOMGAME_PVP" for LAN, inside of general_log.
