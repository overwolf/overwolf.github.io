...
team | players | Player’s current team – Orange/Blue/Spectator  | See [notes](#team-notes)  |   123.0 |
health | players | Player’s current health | See [notes](#health-notes)  |   123.0 |
score | players | Player’s current score or `null` | See [notes](#score-notes) |   123.0 |
kills | players | Total number of kills by the player or `null` |  See [notes](#kills-notes) |   123.0 |
deaths | players | Total number of player's deaths or `null` | See [notes](#deaths-notes)  |   123.0 |
