...
:::tip
If you would like to know when the user is going to play TFT (hit the "Play" button), you can listen to the LoL Launcher [lobby_info](../launchers/events/league-of-legends#info-updates-3) info-update, and check the `queueID`. If it's 1090 or 1100 - it's TFT.
