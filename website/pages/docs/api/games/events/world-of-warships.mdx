...
<GameInfo gameID={10746} showCompliance={true} showDocs={false}/>
...
It's highly recommended to communicate errors to your users. Check game event status [here](/status/all) or easily verify event status straight from your app [using our API](/topics/using-events/how-to-check-events-status-from-app).
