...
<GameInfo gameID={7764} showCompliance={true} showDocs={false}/>
...
match_outcome | match_info  |	win/lose/tie or palyer's name in AArms Race game mode See [notes](#match_outcome-note)	| | 140.0  |
...
In Arms Race game mode the 'match_outcome' value will be the winner's name 
In all the other game modes possible values are win, lose or tie
...
{"info":{"match_info":{"match_outcome":"Jacks123"}},"feature":"match_info"}
```
