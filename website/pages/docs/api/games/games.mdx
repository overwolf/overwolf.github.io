...
OOP stands for "Out of process" Overlay - relevant for Destiny 2, CSGO, and warzone that requires [exclusive mode](/topics/best-practices/exclusive-mode) to interact with the OW app's windows. 
