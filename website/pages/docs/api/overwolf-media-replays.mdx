...
| peripherals  | [StreamPeripheralsCaptureOptions](overwolf-streaming#streamperipheralscaptureoptions-object) Object | Defines how peripherals (i.e. mouse cursor) are streamed.<br></br>**Permissions required: DesktopStreaming**                                                                                                 | 0.78  |
...
| capture_desktop|  [StreamDesktopCaptureOptions](overwolf-streaming#streamdesktopcaptureoptions-object) Object |Defines the desktop streaming options.<br></br>Permissions required: DesktopStreaming | 0.83  |
