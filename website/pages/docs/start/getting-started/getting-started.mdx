...
<CodeBlock typeLabel={'Start'}>
  <CodeBlockItem keyName={'settings'}>
    <CodeBlockComment comment={'bla bla bla'} />
    <CodeBlockComment comment={'bla bla bla bla'} />
    <CodeBlock>
      <CodeBlockItem keyName={'zip'}>
        <CodeBlockSingleItem key={'bibi'} value={'bibizem'} />
      </CodeBlockItem>
      <CodeBlockItem keyName={'zap'}>
          <p>sadassadasdasd</p>
      </CodeBlockItem>
    </CodeBlock>
  </CodeBlockItem>

  <CodeBlockItem keyName={'bap'}>
      <p>sadassadasdasd</p>
  </CodeBlockItem>
</CodeBlock>
