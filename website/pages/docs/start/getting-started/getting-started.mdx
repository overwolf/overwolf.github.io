...
<OWTabs>
<OWTabItem
  tabID={'overwolf-platform'}
  label={'Overwolf Platform'}
  iconSrc={'/img/getting-started/overwolf-app-icon-dark.svg'}>
...
<OWTabItem
  tabID={'electron-platform'}
  label={'Overwolf Electron'}
  iconSrc={'/img/getting-started/electron-app-icon.svg'}>
