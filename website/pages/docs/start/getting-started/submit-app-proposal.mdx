...
<SkipMe>
TODO - make sure to incorporate this elsewhere, and check that it isn't REQUIRED to be here under legal.
:::tip
You do not need to be part of a registered business or company to work on (and make money from) Overwolf apps - Overwolf is open to independent developers and companies alike.
:::
</SkipMe>


:::tip ow-electron
[Overwolf Electron](/tools/ow-electron) applications currently do not need to go through the app proposal process.
However, if you still wish to get feedback on your idea, feel free to [contact us](/support/contact-us)!
:::
...
This proposal (and the app itself) must be made in English, although you may freely support as many other languages as youw ant in the final app.
