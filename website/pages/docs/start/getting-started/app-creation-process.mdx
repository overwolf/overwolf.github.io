...
- Take a look around this website - Can you spot the things you may need?
  - Specifically, did you take a look at [popular app features](http://localhost:3001/start/getting-started#what-can-apps-do)? Do any of these tie in to your design?
...
<SimpleTab groupId="frameworks" choices={
  {
    "overwolf-platform": "Was your submission approved? First of all, congratulations!",
    "electron-platform": ""
  }
}/>
