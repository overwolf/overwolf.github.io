...
so that we can use the important space more effectively for the app's features, and users wouldn't feel like their experience was hurt.
This would include the usage of:
- Unused margins.
- Empty corners.
...
users, and app developers alike. You can read more about that [here](advertising-policy).
