...
<OWTable headerCellNames={['Layout', 'Revenue Est. ($)', 'Overview']}>
  ...
  />
  <AdsLayoutRow 
    assetsPath='/assets/start/monetize-your-app/advertising/recommended-ads-layouts/desktop/two-ads-group'
    name='Two Ads (Group)'
  ...
  />
  <AdsLayoutRow 
    assetsPath='/assets/start/monetize-your-app/advertising/recommended-ads-layouts/desktop/triple-ads-split'
...
<OWTable headerCellNames={['Layout', 'Revenue Est. ($)', 'Overview']}>
  ...
  />
  <AdsLayoutRow 
    assetsPath='/assets/start/monetize-your-app/advertising/recommended-ads-layouts/in-game/triple-ads-split'
    name='Triple Ads (split)'
