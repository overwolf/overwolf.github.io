...
* Use the following [link](https://creator.tebex.io/creator-segment/5) to create an Overwolf App type store.
...
* Create a package for every plan you wish to support, supplying it with all the details you want. Keep in mind that:
  ...
  * **Do note include packages that have been removed...** - MUST be set to on, to ensure that users who cancelled a subscription in the past can still purchase a new one in the future.
