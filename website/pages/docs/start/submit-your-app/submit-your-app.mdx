...
Through the console, you will be able to upload a new app version and [update your store listing page](/tools/developers-console/update-store-listing), with all of your app's information, like screenshots, description, etc.

Here is the list of the required store assets before an app can be launched:
...
:::warning
**This is different from the store tile description**, which is included in the app's [manifest.json](/api/manifest#meta-description)
:::
