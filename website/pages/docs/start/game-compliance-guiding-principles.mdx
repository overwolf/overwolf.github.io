...
Some games have additional limitations on creating apps for them, which you can find under Game Compliance (For example, [Call Of Duty - Warzone](warzone-compliance)). Please Make sure to read through the specific guidelines for the games you are targeting, if those exist!
:::
