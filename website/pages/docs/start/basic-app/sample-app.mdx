...
[Download here](https://www.overwolf.com/app/Sample_App).  
:::
...
(Note that to do that you have to **[whitelist](../getting-started/sdk-introduction#whitelist-as-a-developer)** your OW username as a developer).
