...
- "Native" - This sample app is just made up of plain, vanilla javascript. This sample app can be loaded as unpacked directly, meaning that you can skip to [this section](5-install-the-app-as-unpacked-extension).
