...
In order to get a 300x250 video test ad enabled on your app, please follow these steps:

1. Open app
2. Paste `localStorage.owAdsForceAdUnit = "Ad_test_300x250"` into the console
3. Press F5 to refresh window
4. Open http://localhost:54284
5. Open app
