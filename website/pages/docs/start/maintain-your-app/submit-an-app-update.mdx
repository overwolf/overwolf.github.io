...
To get the update cycle started, head on over to the [developers' console](https://console.overwolf.com), and select your app. From there, follow the instructions detailed [here](/tools/developers-console/dashboard/release-management/production).

## App version review

For the first few versions of your app, an update might need to be submitted for review.

This is done through the developers' console, or through your assigned dev-rel manager.
