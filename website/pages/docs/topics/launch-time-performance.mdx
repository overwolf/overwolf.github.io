...
<ImageSlider>
  <img src={require('../assets/launch-time-performance/THLoader.jpg').default} alt="Trophy Hunter loader" />
  <img src={require('../assets/launch-time-performance/CSGOScoutloader.png').default} alt="CSGO Scout loader" />
</ImageSlider>
