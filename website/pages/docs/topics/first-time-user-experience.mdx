...
<ImageBoxModal>
  <img src={require('../assets/Firsttimeuserexperience/Champ-select.png').default} alt="Legendary Builds" />
</ImageBoxModal>
...
<ImageSlider miniSlides={true}>
  <img src={require('../assets/Firsttimeuserexperience/Builds-are-ready.png').default} alt="Legendary Builds"/>
  <img src={require('../assets/Firsttimeuserexperience/lbingame113.png').default} alt="Legendary Builds"/>
</ImageSlider>
...
<ImageBoxModal>
  <img src={require('../assets/Firsttimeuserexperience/lolwiz-home.jpg').default} alt="Lolwiz" />
</ImageBoxModal>
...
<ImageBoxModal>
  <img src={require('../assets/Firsttimeuserexperience/Killervoices123.png').default} alt="Killer Voices" />
</ImageBoxModal>
