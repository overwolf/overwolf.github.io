...
We've created a few simple plugins that might answer your needs as an app developer or give you a good starting point for developing your own, you can find them in the [Overwolf GitHub repository](https://github.com/overwolf/plugins).
