...
Download the SDK from [this repository](https://github.com/overwolf/game-events-sdk).

1. Include the 32/64 DLL with your game.
2. Review the tester.
3. Start updating your code with interesting events. Check out our [Game Events Convention](/topics/using-events/game-events-convention) for tips.
4. If you want more ideas for interesting events to expose, based on our experience, feel free to [contact us](/support/contact-us)!
