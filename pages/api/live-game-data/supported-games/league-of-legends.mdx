...
usedAbility  | JSON containing: “type” with the ability number between 1-4. Example:<br></br> `{ type: "4" }` for ult        | player activated the ability	 |  “usedAbility” fired when the player actually activated the ability  |   0.31       |
...
* Camp 9 = Wolves West
* Camp 10 = Wolves East
* Camp 11 = Raptors West
* Camp 12 = Raptors East
* Camp 4 = Red West 
* Camp 5 = Red East
* Camp 13 = Krug West
* Camp 14 = Krug East
* Camp 6 = Dragon
* Camp 16 = Baron (icon_status always remains zero).
* Camp 7 = Gromp West
* Camp 8 = Gromp East
* Camp 18 = Scuttle Crab River Bot side
* Camp 19 = Scuttle Crab River Top side
* Camp 15 = Rift Herald (icon_status always remains zero).
* Camp 17 = VoidGrubs (icon_status always remains zero).
...
This info update is showing the cooldown timer of the ultimate ability of each player in seconds.<br></br>
