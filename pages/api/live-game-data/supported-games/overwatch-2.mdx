...
As for version 249.1.0 hero_name and hero_role will be availabe for the local player team only
We will add it to the other team in the next GEP release
