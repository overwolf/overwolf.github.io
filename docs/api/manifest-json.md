...
| <a class="anchor" aria-hidden="true" id="enable_osr_acceleration"></a>enable_osr_acceleration | bool |  Enable OSR/GPU acceleration if supported by this machine. </br>*Note 1: The OSR acceleration feature is is no longer supported and maintained.*</br>*Note 2: This flag is only relevant for D3D11 supported games.* </br>*Note 3: see also the [optimize_accelerate_rendering](#optimize_accelerate_rendering) flag.* |0.126  |
