...
| <a class="anchor" aria-hidden="true" id="windows-min_size"></a>min_size      | [size](#size-object) object |  Defines the minimum size of the window in pixels. Default value is 100x100 pixels. </br> See our [window sizes tips](../topics/windows-resolution-size-position#window-sizes)                                                                         | 0.78  |
