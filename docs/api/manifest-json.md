...
| <a id="windows-min_size">min_size</a>      | [size](#size-object) object |  Defines the minimum size of the window in pixels. See our [window sizes tips](../topics/using-overwolf-windows#windows-sizes)                                                                         | 0.78  |
| <a id="windows-max_size">max_size</a>      | [size](#size-object) object |  Defines the maximum size of the window in pixels. See our [window sizes tips](../topics/using-overwolf-windows#windows-sizes)                                                                        | 0.78  |
