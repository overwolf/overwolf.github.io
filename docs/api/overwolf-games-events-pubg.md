...
headshots | match_info   | Total number of headshots in the match |                       |   127.0.7       |
total_damage_dealt      | match_info   | Total damage dealt in the current match |   |   127.0.7       |
max_kill_distance      | match_info   | Max kill distance in CM|          |   127.0.7       |
...
damage_dealt   | amount of damage dealt by the local player |  The local player “damaged” an enemy or himself |      |   127.0.7       | 
fire   | null        |  When local player attacks.  | Relevant also for fists. |   128.0.13       | 
...
bodyPosition       | me   | The local player’s peek-position.<ul><li>‘leanLeft’</li><li>‘leanRight’</li><li>‘straight’ |                       |   128.0.13        |
inVehicle       | me   | Whether local player is inside a vehicle or not.<ul><li>‘null’Bool - ‘True‘/‘False‘ | Valid for the airplane as well. |   128.0.13        |
aiming       | me   | The player’s different type of aim-focus usage.<ul><li>‘null’</li><li>‘focusedAim’</li><li>‘aimDownSight’</li><li>aimDownSight_holding_breath’ |                       |   128.0.13        |
view       | me   | The player’s perspective (Third Person/First Person).<ul><li>‘TPP’</li><li>‘FPP’</li> |                       |   128.0.13        |
freeView       | me   | When the local player uses ‘ALT’ feature to look around.<ul><li>Bool - ‘True‘/‘False‘</li> |                       |   128.0.13        |
movement       | me   | The player’s type of movement speed.<ul><li>‘normal’</li><li>‘fast’</li><li>‘stealth’</li> |                       |   128.0.13        |
...
Event      | Event Data  | Fired When          | Notes              | Since Version |
-----------| ------------| ------------------------------- | ------------------ | --------------|
jump | null        | Local player jumps (space) |   |   128.0.13       |
...
key                | Category    | Values                                         | Notes  | Since Version |
-------------------| ------------| -----------------------------------------------| ------ | ------------- |
map    | match_info   | The current map name</br>`{"map":"Erangel_Main"}`   | [map names mapping](https://github.com/pubg/api-assets/blob/master/dictionaries/telemetry/mapName.json) |    90.0       |
...
Event      | Event Data  | Fired When          | Notes              | Since Version |
-----------| ------------| ------------------------------- | ------------------ | --------------|
revived | null        | The local player was revived |   |   90.0    |
...
Event      | Event Data  | Fired When          | Notes              | Since Version |
-----------| ------------| ------------------------------- | ------------------ | --------------|
death | null | The local player dies |   |   90.0    |
knockedout | null | The local player is knocked-out |   |   90.0    |
damageTaken | null | The local player receives damage. | Not including damage </br>taken when outside the zone. | 128.0.13 |
