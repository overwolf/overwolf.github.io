...
* [`placeOnClipboard()`](#placeonclipboarddata)
* [`getFromClipboard()`](#getfromclipboardcallback)
* [`getMonitorsList()`](#getmonitorslistcallback)
* [`sendKeyStroke()`](#sendkeystrokekeystring)
* [`openFilePicker()`](#openfilepickerfilter-callback)
* [`openFolderPicker()`](#openfolderpickerinitialpath-callback)
* [`openWindowsExplorer()`](#openwindowsexplorerurl-callback)
* [`isTouchDevice()`](#istouchdevicecallback)
* [`openUrlInDefaultBrowser()`](#openurlindefaultbrowserurl)
* [`getSystemInformation()`](#getsysteminformationcallback)
* [`getPeripherals()`](#getperipheralscallback)
* [`openStoreOneAppPage()`](#openstoreoneapppageappid)
* [`isMouseLeftButtonPressed()`](#ismouseleftbuttonpressedcallback)
* [`uploadClientLogs()`](#uploadclientlogscallback)
