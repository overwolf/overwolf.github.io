...
* Latest public version: [`$latest-ver`](changelogs/overwolf-platform/$latest-path/$latest-ver) (Released on: $latest-date)
* Latest developers' version: [`$dev-ver`](changelogs/overwolf-platform/$dev-path/$dev-ver) (Released on: $dev-date)
